...
//{ name, price, images, description, colors, company, stock, reviews, category, shipping }
    return (
        <>
        <div className={"fixed w-full h-screen sm:h-auto top-0 left-0 flex justify-center items-start overflow-y-auto " + styles.quickView} style={{ zIndex: '1200'}}>
            <div className={`relative max-w-screen-xl my-48 mb-20 overflow-y-auto rounded-lg ${styles.quickView_wrapper}`} style={{ zIndex: '200'}}>
